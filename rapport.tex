...
\fancyfoot[L]{\small\color{grisTexte}\textit{Rapport de TPs -- 2025/2026}}
...
\screenshot{hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh}
...
public class BienImmobilier {
    ...
    public void affiche(){
        ...
        System.out.println("La valeur locative estimee: " + valeurEst);
    }
...
public class VehiculeThermique extends Vehicule{
    ...
    public VehiculeThermique(String immatriculation, int capacite,
            double consommationBase, double niveauCarburant,
            String typeCarburant, int cylindree){
    ...
    public double calculerEfficacite(){
        return (getCapacite() * 100)
            / (getConsommationBase() * cylindree / 1000);
    }
    ...
    public String toString(){
        return ("immatriculation: " + getImmatriculation() +
            "\nautonomie: " + calculerAutonomie() +
            "\nefficacite: " + calculerEfficacite() +
            "\npollution: " + calculerPollution());
    }
}
\end{lstlisting}
...
\screenshot{Screenshot 2026-05-03 162849.png}
...
public class Employe implements Comparable<Employe>{
    ...
    public Employe(int id, String nom, String departement,
                   double salaire) {
        this.id = id;
        this.nom = nom;
...
public class MultiplesReel {
    ...
    public void lireEtAfficher(String nomFichier){
        try (DataInputStream in = new DataInputStream(
            ...
            System.out.println("La valeur du reel base : "
                + baseD);
            System.out.println("Le nombre de multiples stockes : "
                + cout);
        }
        catch (IOException e) {
    ...
    public static void main(String[] arg) {
        ...
        m.ecrireMultiples("./src/TP9/multiples.dat", 10);
        m.lireEtAfficher("./src/TP9/multiples.dat");
    }
}
\end{lstlisting}
...
\begin{flushright}
  \begin{mdframed}[linecolor=grisBorder, linewidth=0.5pt,
    ...
    {\color{grisTexte}
      ...
      \textit{IID1~~·~~ENSA Khouribga~~·~~2025/2026}
    }
  \end{mdframed}
\end{flushright}
